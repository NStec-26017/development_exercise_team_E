...
//         // ③ 取ってきたデータを、画面表示用の Formに詰め替えて初期値をセット
...
//                 !productRepository.existsCategory(form.getProductCategoryId())) {
//             result.rejectValue("productCategoryId", "error.invalidCategory",
//                     "カテゴリを選択してください");
